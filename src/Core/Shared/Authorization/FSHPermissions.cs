...
public static class FSHPermissions
{
    private static readonly FSHPermission[] _all = new FSHPermission[]
    {
        ...
        new("Search Blogs", FSHAction.Search, FSHResource.Blogs, IsBasic: true),
        new("View Blogs", FSHAction.View, FSHResource.Blogs, IsBasic: true),
        new("Create Blogs", FSHAction.Create, FSHResource.Blogs),
        new("Update Blogs", FSHAction.Update, FSHResource.Blogs),
        new("Delete Blogs", FSHAction.Delete, FSHResource.Blogs),
        new("Clean Blogs", FSHAction.Clean, FSHResource.Blogs),
    };

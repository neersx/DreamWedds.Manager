...
using DreamWedds.Manager.Domain.Common;
using DreamWedds.Manager.Infrastructure.Common.Extensions;

namespace DreamWedds.Manager.Infrastructure.FileStorage;
